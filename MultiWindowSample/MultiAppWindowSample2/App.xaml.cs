...
namespace MultiAppWindowSample2
{
    ...
    sealed partial class App : Application
    {
        ...
        private async void App_CloseRequested(object sender, SystemNavigationCloseRequestedPreviewEventArgs e)
        {
            ...
            var dialog = new MessageDialog("Do you want to save secondary windows' placment?", "Exit");
            ...
            {
                AppViewModel.UpdateAppWindowsPlacements();
            }
            AppViewModel.CloseAllSecondaryWindows();
            deferral.Complete();
        }
        /// <summary>
